<?php
    ...
    $consulta = sprintf("(SELECT questao, pergunta.id_perguntas FROM pergunta INNER JOIN pergunta_has_alternativa WHERE pergunta.id_perguntas = pergunta_has_alternativa.id_perguntas UNION SELECT questao, pergunta.id_perguntas FROM pergunta NATURAL JOIN subpergunta_has_pergunta NATURAL JOIN subpergunta NATURAL JOIN subpergunta_has_alternativa WHERE pergunta.id_perguntas = subpergunta_has_pergunta.id_perguntas AND subpergunta.id_subpergunta = subpergunta_has_alternativa.id_subpergunta) ORDER BY id_perguntas;");
...
<html lang="pt-br">
	...
	<body>
		...
		<form method = "POST" action = "graficosuperior.php">
            <br>
			<div class = "corpo">
                <div class = "card text-center">
                    <div class = "card-header"> 
                        <br><h1>Selecione as questões para análise gráfica</h1><br>
                    </div> 	
                    ...
                    <br><div class = "botao">
                        ...
                        <input id = "botao" type = "submit" class= "btn btn-primary" name = "constuir" value = "Construir gráfico"/>
                    </div><br>
