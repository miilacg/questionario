          ...
          <div class = "card text-center"> 
            ...
            <div class= "card-body"> 	
              ...
              <div class = "slider-wrapper" id = "q50">
                ...
                Assembly<br><input type = "range" list = "tickmarks" name = "50S" min = "1" max = "5"/> 
                <datalist id="tickmarks">
                  <option value="1">
                  <option value="2">
                  <option value="3">
              ...
              <div class = "botao">
                <a href = "mercadosup.php"><input id = "botao" type = "button" class= "btn btn-primary" value = "Anterior"/></a>
